...
import (
	...
	"github.com/liangjies/req-eth/eth"
	"github.com/liangjies/req-eth/jsonrpc"
)
...
func TestQuantity_DeepCopyInto(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		...
		go func() {
			...
			// code here: https://github.com/liangjies/req-eth/blob/master/eth/zz_deepcopy_generated.go#L19
			cpy := src
